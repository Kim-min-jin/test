...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/customer/layout.css" type="text/css" rel="stylesheet" />
	<style>
				...
				<form action="list" method="post">
					<div class="notice margin-top">
						...
						<table class="table">
							...
							<tr>
								<td>${n.id}</td>
								<td class="title indent text-align-left"><a href="detail?id=${n.id}">${n.title}</a><span>[2]</span></td>
								<td>${n.writerId}</td>
